from pipelines.database import *
...
class CopyToFile(BaseTask):
    ...
    def __init__(self, table, output_file, connection = 'database.db'):
        self.table = table
...
class LoadFile(BaseTask):
    ...
    def __init__(self, table, input_file, connection='database.db'):
        self.table = table
...
class RunSQL(BaseTask):
    ...
    def __init__(self, sql_query, title=None, connection='database.db'):
        self.title = title
...
class CTAS(BaseTask):
    ...
    def __init__(self, table, sql_query, title=None, connection='database.db'):
        self.table = table
        self.sql_query = sql_query
